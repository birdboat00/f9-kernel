...
#ifndef __PLATFORM_STM32L4_NVIC_H__
...
#define IRQ_VEC_N_HANDLER_DECLARE(n) void nvic_handler##n(void);

#define IRQ_VEC_N_OP IRQ_VEC_N_HANDLER_DECLARE
#include "platform/stm32l4/nvic_private.h"
#undef IRQ_VEC_N_OP
...
typedef struct {
    ...
    volatile uint8_t IP[240]; /*!< Offset: 0x300 (R/W)  Interrupt Priority
                                 Register (8Bit wide) */

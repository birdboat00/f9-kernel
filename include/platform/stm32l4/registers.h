/* STM32L4 Registers and Memory Locations */

#ifndef STM32L4_REGISTERS_H_INCLUDED
#define STM32L4_REGISTERS_H_INCLUDED
...
/* APB2 peripherals - STM32L4 offsets (different from F4) */
#define TIM1_BASE (APB2PERIPH_BASE + 0x2C00)
#define TIM8_BASE (APB2PERIPH_BASE + 0x3400)
#define USART1_BASE (APB2PERIPH_BASE + 0x3800)
/* No USART6 on STM32L475 */
...
#define GPIO_BASE(port) \
    (0x48000000 + (0x400 * port)) /* GPIO Port base address */
#define RCC_BASE       \
    (AHB1PERIPH_BASE + \
     0x1000) /* Reset and Clock Control base address (L4: 0x40021000) */
#define FLASH_R_BASE   \
    (AHB1PERIPH_BASE + \
     0x2000) /* Flash registers base address (L4: 0x40022000) */
...
/* STM32L4 RCC enable registers (different offsets from F4) */
#define RCC_AHB1ENR \
    (volatile uint32_t *) (RCC_BASE + 0x48) /* AHB1 Enable Register */
#define RCC_AHB2ENR \
    (volatile uint32_t *) (RCC_BASE + 0x4C) /* AHB2 Enable Register */
#define RCC_APB1ENR                   \
...
#define PWR_CR_VOS                                                          \
    (uint16_t) (1 << 9) /* Regulator voltage scaling output selection - L4: \
                           VOS[1:0] bits 10:9, use 01b for Range 1 (80MHz) */

#define MSI_VALUE (uint32_t) (4000000)  /* MSI default value in Hz (Range 6) */
...
/* STM32L4 PLLSRC is bits [1:0]: 01=MSI, 10=HSI16, 11=HSE */
#define RCC_PLLCFGR_PLLSRC_MSI (uint32_t) (1) /* MSI selected as PLL input */
#define RCC_PLLCFGR_PLLSRC_HSI                                               \
    (uint32_t) (2)                            /* HSI16 selected as PLL input \
                                               */
#define RCC_PLLCFGR_PLLSRC_HSE (uint32_t) (3) /* HSE selected as PLL input */
#define RCC_PLLCFGR_PLLM (uint32_t) (0x003F)
#define RCC_PLLCFGR_PLLN (uint32_t) (0x7FC0)
#define RCC_PLLCFGR_PLLP (uint32_t) (0x00030000)
#define RCC_PLLCFGR_PLLR (uint32_t) (0x06000000) /* L4: PLLR bits [26:25] */
